...

{
    ...
    public function gerarRelatorioPDF()
    {
        ...
        // Adiciona uma imagem no cabeçalho (substitua 'caminho/para/sua_imagem.png' pelo caminho correto da sua imagem)
        $imagePath = '';
        if (file_exists($imagePath)) {
            $pdf->Image($imagePath, 15, 10, 30); // Ajuste a posição e o tamanho conforme necessário
        }
        ...
        $pdf->Ln(5); // Reduzindo o espaçamento

        // Exibe o título para as informações das obras
        $pdf->SetFont('helvetica', 'B', 14);
        $pdf->Cell(0, 8, 'Informações das Obras', 0, 1, );
        $pdf->Ln(5); // Reduzindo o espaçamento após o título

        // Preenchendo os dados no formato de tabela com classes do Bootstrap
        $pdf->SetFont('helvetica', '', 12); // Fonte padrão para os dados das obras
        $html = '';
        ...
        </table><br><hr><br>'; // Linha horizontal entre cada obra para organização
        }
