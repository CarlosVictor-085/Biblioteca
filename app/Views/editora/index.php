<div class="container">
    ...
    <!-- Button do Modal de cadastro de editora -->
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li>
                                        ...
                                        <a class="dropdown-item text-info"
                                            href="<?= base_url('Editora/editar/' . $e['id']) ?>">
                                    ...
                                    <li>
                                        ...
                                        <a class="dropdown-item text-danger delete-link" data-id="<?= $e['id'] ?>"
                                            href="#">
...
<?php echo form_open('Editora/excluir', ['id' => 'formExcluir']); ?>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                Tem certeza de que deseja excluir este editora?
...
<script src="<?= base_url('assets/jquery/exclusaodeeditora.js') ?>"></script>